...
$(document).ready(function () {
    ...
    axios({
        method: 'post',
        url: 'http://phpstack-399934-1259248.cloudwaysapps.com/backend/fetch-user.php'
    })
        .then(function (response) {
            //handle success
            console.log(response);
            ...
            $.each(response.data, function (key, value) {
                ...
                if (value.ROLE == 4) {
                    var currentUrl = 'http://phpstack-399934-1259248.cloudwaysapps.com/gp2/admin/edit_faculty.html';
                ...
                if (value.ROLE == 3) {
                    var currentUrl = 'http://phpstack-399934-1259248.cloudwaysapps.com/gp2/admin/edit_quality.html';
                    var url = new URL(currentUrl);
                    url.searchParams.set("id", value.ID);
                    var newUrl = url.href;
                    role = 'Quality Member';
