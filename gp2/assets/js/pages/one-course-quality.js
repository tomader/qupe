...
$(document).ready(function () {
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/fetch-deadline.php',
        data: {
            course_id: courseId
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/submitted-cs.php',
        data: {
            course_id: courseId
        }
    })
            ...
            $.each(response.data, function (key, value) {
                ...
                axios({
                    ...
                    .then(function (response) {
                        //handle success
                        console.log(response);
                        var currentUrl = 'https://qupe.herokuapp.com/gp2/qualityMember/CourseSpeci.html';
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/submitted-cr.php',
        data: {
            course_id: courseId
        }
    })
        .then(function (response) {
            ...
            $.each(response.data, function (key, value) {
                ...
                axios({
                    ...
                    .then(function (response) {
                        //handle success
                        var currentUrl = 'https://qupe.herokuapp.com/gp2/qualityMember/CourseReport.html';
                        var url = new URL(currentUrl);
                        url.searchParams.set("id", value.ID);
