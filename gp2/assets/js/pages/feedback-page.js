            ...
            $.each(response.data, function (key, value) {
                axios({
                    ...
                    .then(function (response) {
                        ...
                        console.log(response);
                        let time = value.TIME;
                        var currentUrl = 'http://phpstack-399934-1259248.cloudwaysapps.com/gp2/faculty/feedback-CS.html';
            ...
            $.each(response.data, function (key, value) {
                axios({
                    ...
                    .then(function (response) {
                        ...
                        console.log(response);
                        let time = value.TIME;
                        var currentUrl = 'http://phpstack-399934-1259248.cloudwaysapps.com/gp2/faculty/feedback-CR.html';
                        var url = new URL(currentUrl);
                        url.searchParams.set("id", value.ID);
