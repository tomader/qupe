...
$(document).ready(function () {
    ...
    axios({
        method: 'post',
        url: 'https://gpqupe.000webhostapp.com/backend/fetch-feedback-CS.php'
    })
            ...
            $.each(response.data, function (key, value) {
                axios({
                    ...
                    .then(function (response) {
                        ...
                        console.log(response);
                        let time = value.TIME;
                        var currentUrl = 'https://gpqupe.000webhostapp.com/gp2/faculty/feedback-CS.html';
    ...
    axios({
        method: 'post',
        url: 'https://gpqupe.000webhostapp.com/backend/fetch-feedback-CR.php'
    })
        .then(function (response) {
            //handle success
            console.log(response);
            $.each(response.data, function (key, value) {
                axios({
                    ...
                    .then(function (response) {
                        ...
                        console.log(response);
                        let time = value.TIME;
                        var currentUrl = 'https://gpqupe.000webhostapp.com/gp2/faculty/feedback-CR.html';
                        var url = new URL(currentUrl);
                        url.searchParams.set("id", value.ID);
