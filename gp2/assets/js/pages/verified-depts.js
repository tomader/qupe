...
function getNumberOfAllUsers(dept_id) {
    axios({
        method: 'post',
        url: 'http://phpstack-399934-1259248.cloudwaysapps.com/backend/fetch-numberOf-all-users-from-dept.php',
        data: {
            dept: dept_id
        }
    })
...
function getNumberOfUsers(dept_id) {
    axios({
        method: 'post',
        url: 'http://phpstack-399934-1259248.cloudwaysapps.com/backend/asshole.php',
        data: {
            dept: dept_id
        }
    })
                            ...
                            .then(function (response2) {
                                ...
                                axios({
                                    ...
                                    .then(function (response3) {
                                        ...
                                        var currentUrl = 'http://phpstack-399934-1259248.cloudwaysapps.com/gp2/TheHead/verified-users.html';
