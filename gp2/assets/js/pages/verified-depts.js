...
function getNumberOfAllUsers(dept_id) {
    axios({
        method: 'post',
        url: 'https://gp2.herokuapp.com/backend/fetch-numberOf-all-users-from-dept.php',
        data: {
            dept: dept_id
        }
    })
...
function getNumberOfUsers(dept_id) {
    axios({
        method: 'post',
        url: 'https://gp2.herokuapp.com/backend/asshole.php',
        data: {
            dept: dept_id
        }
    })
                            ...
                            .then(function (response2) {
                                ...
                                axios({
                                    ...
                                    .then(function (response3) {
                                        ...
                                        var currentUrl = 'https://gp2.herokuapp.com/gp2/TheHead/verified-users.html';
