...
function getNumberOfAllUsers(dept_id) {
    axios({
        method: 'post',
        url: 'https://qupe.000webhostapp.com/backend/fetch-numberOf-all-users-from-dept.php',
        data: {
            dept: dept_id
        }
    })
...
function getNumberOfUsers(dept_id) {
    axios({
        method: 'post',
        url: 'https://qupe.000webhostapp.com/backend/asshole.php',
        data: {
            dept: dept_id
        }
    })
                            ...
                            .then(function (response2) {
                                ...
                                axios({
                                    ...
                                    .then(function (response3) {
                                        ...
                                        var currentUrl = 'https://qupe.000webhostapp.com/gp2/TheHead/verified-users.html';
