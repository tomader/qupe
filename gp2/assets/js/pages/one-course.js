...
$(document).ready(function () {
    ...
    axios({
        method: 'post',
        url: 'http://phpstack-399934-1259248.cloudwaysapps.com/backend/oneCourse.php',
        data: {
            course_id: courseId
        }
    })
        .then(function (response) {
            ...
            $.each(response.data, function (key, value) {
                //handle success
                console.log(value);
                var currentUrl = 'http://phpstack-399934-1259248.cloudwaysapps.com/gp2/faculty/NewCS.html';
                var url = new URL(currentUrl);
                url.searchParams.set("id", value.ID);
                var newCS = url.href;
                var currentUrl = 'http://phpstack-399934-1259248.cloudwaysapps.com/gp2/faculty/CourseSpeci.html';
                var url = new URL(currentUrl);
                url.searchParams.set("id", value.ID);
                var courseSpeci = url.href;
                var currentUrl = 'http://phpstack-399934-1259248.cloudwaysapps.com/gp2/faculty/NewCR.html';
                var url = new URL(currentUrl);
                url.searchParams.set("id", value.ID);
                var newCR = url.href;
                var currentUrl = 'http://phpstack-399934-1259248.cloudwaysapps.com/gp2/faculty/CourseReport.html';
                var url = new URL(currentUrl);
                url.searchParams.set("id", value.ID);
                ...
                if (value.STATUS == 0) {
                    $select.append('<div id="icon-color" class="kt-portlet kt-iconbox kt-iconbox--wave">' +
                        ...
                        'height="2" rx="1" /></g>' +
                        '</svg>  <span class= "kt-badge   kt-badge--inline " >New</span ></div>' +
                        '<div class="kt-iconbox__desc">' +
                        '<h3 class="kt-iconbox__title"><a class="kt-link" href="' + newCS + '">Course Specification</a></h3>' +
                ...
                else if (value.STATUS == 1 || 2) {
                    $select.append('<div id="icon-color" class="kt-portlet kt-iconbox kt-iconbox--wave kt-iconbox--success">' +
                        ' <div class= "kt-portlet__body" >' +
                        '<div class="kt-iconbox__body">' +
                        ...
                        'fill="#000000" />' +
                        '</g>' +
                        '</svg>  <span class= "kt-badge   kt-badge--inline " >Submitted</span ></div>' +
                        '<div class="kt-iconbox__desc">' +
    ...
    axios({
        method: 'post',
        url: 'http://phpstack-399934-1259248.cloudwaysapps.com/backend/oneCourse-cr.php',
        data: {
            course_id: courseId
        }
    })
            ...
            $.each(response.data, function (key, value) {
                ...
                if (value.STATUS == 0) {
                    $('#cr').append('<div id="icon-color" class="kt-portlet kt-iconbox kt-iconbox--wave">' +
                        ...
                        '</svg>  <span class= "kt-badge   kt-badge--inline " >New</span ></div>' +
                        '<div class="kt-iconbox__desc">' +
                        '<h3 class="kt-iconbox__title"><a class="kt-link" href="' + newCR + '">Course Report</a></h3>' +
                    ...
                    $('#cr').append('<div id="icon-color" class="kt-portlet kt-iconbox kt-iconbox--wave kt-iconbox--success">' +
                        ' <div class= "kt-portlet__body" >' +
                        '<div class="kt-iconbox__body">' +
