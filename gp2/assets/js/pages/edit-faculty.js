...
function getCoursesFromUser(user_id) {
    axios({
        method: 'post',
        url: 'https://qupe-backend.herokuapp.com/backend/courses-from-userId.php',
        data: {
            user: user_id
        }
    })
...
$(document).ready(function () {
    ...
    $('#edit-user').submit(function (event) {
        ...
        axios({
            method: 'post',
            url: 'https://qupe-backend.herokuapp.com/backend/edit-user.php',
            data: values
        })
            .then(function (response) {
                //handle success
    ...
    $('#delete_user').click(function () {
        ...
        swal.fire({
            ...
            if (result.value) {
                axios({
                    method: 'post',
                    url: 'https://qupe-backend.herokuapp.com/backend/delete-user.php',
                    data: {
                        user_id: userId
                    }
                }).then(function (response) {
