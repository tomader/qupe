...
$(document).ready(function () {
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/fetch-feedbackText-from-crID.php',
        data: {
            cr_id: crID
        }
    })
    ...
    $('#courseReport').submit(function (event) {
        ...
        axios({
            method: 'post',
            url: 'https://unadaptable-odors.000webhostapp.com/backend/edit-courseReport.php',
            data: values
        })
            .then(function (response) {
                //handle success
