...
$(document).ready(function () {
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/userName-from-crID.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/fetch-feedbackText-from-crID.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/cr-tableA.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/cr-tableB1.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/cr-tableB2.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/cr-tableC1.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/cr-tableC2.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/cr-tableD.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/cr-tableE1.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/cr-tableE2.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/cr-tableF.php',
        data: {
            cr_id: crID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://qupe.herokuapp.com/backend/cr-tableG.php',
        data: {
            cr_id: crID
        }
    })
    ...
    $('#courseReport').submit(function (event) {
        ...
        axios({
            method: 'post',
            url: 'https://qupe.herokuapp.com/backend/edit-courseReport.php',
            data: values
        })
            .then(function (response) {
                //handle success
