...
$(document).ready(function () {
    ...
    axios({
        method: 'post',
        url: 'http://phpstack-399934-1259248.cloudwaysapps.com/backend/fetch-feedbackText-from-csID.php',
        data: {
            cs_id: csID
        }
    })
    ...
    $('#courseSpeci').submit(function (event) {
        ...
        axios({
            method: 'post',
            url: 'http://phpstack-399934-1259248.cloudwaysapps.com/backend/edit-courseSpeci.php',
            data: values
        })
            .then(function (response) {
                //handle success
