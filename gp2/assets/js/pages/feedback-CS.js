...
$(document).ready(function () {
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/courseInfo-from-csID.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/fetch-feedbackText-from-csID.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableA.php',
        data: {
            cs_id: csID
        }
    })
    ...
    function getTableA_Mode(modeId) {
        axios({
            method: 'post',
            url: 'https://unadaptable-odors.000webhostapp.com/backend/tableA_Mode.php',
            data: {
                mode_id: modeId
            }
        })
    ...
    function getTableA_Actual(actualId) {
        axios({
            method: 'post',
            url: 'https://unadaptable-odors.000webhostapp.com/backend/tableA_actual.php',
            data: {
                actual_id: actualId
            }
        })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableB.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableB_knowledge.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableB_skills.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableB_competence.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableC.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableD_competence.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableD_Knowledge.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableD_Skills.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableD_Asses.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableF.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableG.php',
        data: {
            cs_id: csID
        }
    })
    ...
    axios({
        method: 'post',
        url: 'https://unadaptable-odors.000webhostapp.com/backend/tableH.php',
        data: {
            cs_id: csID
        }
    })
    ...
    $('#courseSpeci').submit(function (event) {
        ...
        axios({
            method: 'post',
            url: 'https://unadaptable-odors.000webhostapp.com/backend/edit-courseSpeci.php',
            data: values
        })
            .then(function (response) {
                //handle success
